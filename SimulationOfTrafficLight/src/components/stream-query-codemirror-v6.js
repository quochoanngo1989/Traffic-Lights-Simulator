...
class StreamQueryCodeMirrorV6 extends React.PureComponent{
    constructor(props) {
      super(props);
  ...
  lintKeymap: true
      ...
      else
      {
        //const s=initStreamSettings(this.props.log);
            return <div className='QueryV6Component'>
...
const StreamQueryCodeMirrorV6Container = connectToLog({Component: StreamQueryCodeMirrorV6, getLogState});
export default StreamQueryCodeMirrorV6Container;